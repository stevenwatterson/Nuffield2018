...
for _ in repeat(None, no_of_repeats):
    ...
    # Target Variable should be placed on row 2 under class variable
    ...
    nnclassify = neural_network.MLPClassifier(activation="relu", solver="adam", hidden_layer_sizes=400, alpha=0.1, max_iter=600)
